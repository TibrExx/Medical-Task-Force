...
@Mapper(componentModel = "spring", unmappedTargetPolicy = ReportingPolicy.IGNORE, nullValuePropertyMappingStrategy = IGNORE)
public interface VolunteerMapper {
  ...
  @Mapping(source = "upToFiveDaysDuty", target = "availability.upToFiveDaysDuty")
  @Mapping(source = "weekendDuty", target = "availability.weekendDuty")
  Volunteer updateVolunteer(@MappingTarget Volunteer toUpdate, VolunteerDto volunteerDto);
}
